...
//
// 入力処理 (input.h)
// Author : 後藤慎之助(キーボード、コントローラ) / 東村哲士(マウス)
//
//====================================================================
#ifndef _INPUT_H_
#define _INPUT_H_
...
// スティックの各範囲を判別
#define STICK_UP(angle) angle < D3DXToRadian(50.0f) && angle > D3DXToRadian(-50.0f)
#define STICK_RIGHT(angle) angle >= D3DXToRadian(50.0f) && angle <= D3DXToRadian(135.0f)
...
#define STICK_LEFT(angle) angle <= D3DXToRadian(-50.0f) && angle >= D3DXToRadian(-135.0f)
