...
public:
    ...
    void SetAdditiveSynthesis(void) { m_bAdditiveSynthesis = true; }                              // 加算合成にする
    void SetAlphaTest(void) { m_bAlphaTest = true; }                                              // αテストをする
    void SetNega(void) { m_bNega = true; }                                                        // 反転合成をする
