...
//
// カメラ処理 (camera.cpp)
// Author : 後藤慎之助(ゲームに適応させた動きに変える) / 樋宮匠(回転行列を用いたカメラの初期設定) / 東村哲士(マウス対応)
//
//==============================================================================================================================
...
HRESULT CCamera::Init(void)
{
    ...
    m_posRDest = DEFAULT_VECTOR;
    m_posVDest = DEFAULT_VECTOR;
    m_pos = PLAYER_START_POS_STAGE1 + CAMERA_LOCK_ON_POS_ADJUST;
    m_posV = PLAYER_START_POS_STAGE1 + CAMERA_LOCK_ON_POS_ADJUST;
    m_posR = PLAYER_START_POS_STAGE1 + CAMERA_LOCK_ON_POS_ADJUST;
    m_fDistance = CAMERA_LOCK_ON_OFFSET;
