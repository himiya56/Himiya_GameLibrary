...
// ロックオン時のカメラの位置の微調整
#define CAMERA_LOCK_ON_POS_ADJUST D3DXVECTOR3(0.0f, 400.0f, 0.0f)
#define CAMERA_LOCK_ON_OFFSET -450.0f
...
// 視野角
#define CAMERA_VIEW_ANGLE D3DXToRadian(90.0f)
...
public:
    ...
    {
        STATE_NONE = 0,      // なし
        STATE_LOCK_ON,       // プレイヤーにロックオン
        STATE_IN_FADE,       // フェード中
        STATE_FAILD,         // プレイヤーの負け
    }STATE;
