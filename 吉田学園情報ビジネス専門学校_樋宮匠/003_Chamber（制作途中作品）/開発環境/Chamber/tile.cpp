...
HRESULT CTile::Load(void)
{
    ...
    // テクスチャ
    D3DXCreateTextureFromFile(pDevice, "data/TEXTURE/floor.jpg", &m_apTexture[TILE_FLOOR]);
    // テクスチャ
    D3DXCreateTextureFromFile(pDevice, "data/TEXTURE/ceiling.jpg", &m_apTexture[TILE_CEILING]);
    // テクスチャ
    D3DXCreateTextureFromFile(pDevice, "data/TEXTURE/grass000.png", &m_apTexture[TILE_LINE_BLUE]);
    // テクスチャ
    D3DXCreateTextureFromFile(pDevice, "data/TEXTURE/Road001.png", &m_apTexture[TILE_LINE_ORANGE]);
